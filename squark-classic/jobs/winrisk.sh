...
export INCLUDE_TABLES="NAME,SUMMARY,COVERAGES,BILLING,REPLACEMENT_SUMMARY,RATINGS,RIDERS,REQUIREMENTS,NOTES,POLICY_EVENTS,LAB_DEMOGRAPHICS,LAB_RESULTS,ADDITIONAL_RIDER_INFO,DEBITCREDIT_SUMMARY,REINSURANCE_DESC,REINSURANCE_DETAILS,REINSURANCE_SUMMARY,DEBITCREDIT_DETAILS"
#export STATS_CONFIG="
#{
#    'profiles': {
