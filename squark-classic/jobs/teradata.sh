...
export INCLUDE_TABLES='AGMT_CMN_VW,CUST_AGMT_CMN_VW,CUST_DEMOGRAPHICS_VW,PDCR_AGMT_CMN_VW,PDCR_DEMOGRAPHICS_VW,AGMT_UWRT_CMN_VW,PDCR_ALT_ID_CMN_VW,CUST_PREFERENCE_VW,SLLNG_AGMT_CMN_VW,AGMT_VAL_CMN_VW,AGMT_CVG_CMN_VW,BP_CREDENTIAL_VW,AGMT_COMM_TXN_CMN_VW'
