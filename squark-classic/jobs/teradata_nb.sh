...
export INCLUDE_TABLES='NB_APPL_VW,NB_COV_RISK_VW,NB_PRTY_APPL_RLE_VW,NB_APPL_PRTY_VW,NB_PRTY_CASE_OWN_VW,DI_NB_RPT_VW,NB_PRTY_APPL_AD_VW,INSURED_VW,NB_BILL_INFO_VW'
