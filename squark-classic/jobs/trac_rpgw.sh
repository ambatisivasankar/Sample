...
export TZ=GMT
export INCLUDE_TABLES='DIM_AFFILIATE_COMPANY,DIM_ICU,DIM_PARTICIPANT_ACCOUNT,DIM_PLAN_ACCOUNT,DIM_PARTICIPANT,DIM_ACCOUNT_ADMNSTRTR,DIM_SPONSOR_COMPANY,DIM_VRU_ENROLLMENT_STATUS,DIM_CONSENT_CUST,DIM_BENEFICIARY,DIM_PLAN,DIM_EMPLOYEE,FACT_PRTCPNT_ASST_DTL,DIM_RETIREMENT_PROJECTION'
