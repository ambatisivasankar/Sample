...
export INCLUDE_TABLES='AGMT_CMN_VERTICA_VW,AGMT_VAL_CMN_VW,CUST_AGMT_CMN_VW,CUST_DEMOGRAPHICS_VW,PDCR_AGMT_CMN_VW,PDCR_DEMOGRAPHICS_VW,SLLNG_AGMT_CMN_VW,AGMT_ADDL_DATA_VW,AGMT_CVG_CMN_VW,AGMT_FND_CMN_VW,AGMT_FND_VAL_CMN_VW,AGMT_LOAN_CMN_VW,FUND_CMN_VW,AGMT_UWRT_CMN_VW'
